...
output via _Log Components_, but the level of control is not very fine grained
...
Basically, a trace source _is_ a callback to which multiple functions may be
