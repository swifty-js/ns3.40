...
_mechanics_ of documenting models and source code to the
...
- _functionality:_ What functionality should it have? What attributes or
  configuration is exposed to the user?
- _reusability:_ How much should others be able to reuse my design? Can I
  reuse code from |ns2| to get started? How does a user integrate the model
  with the rest of another simulation?
- _dependencies:_ How can I reduce the introduction of outside dependencies on
...
_Here, write a bit about adding |ns3| logging macros. Note that
LOG_COMPONENT_DEFINE is done outside the namespace ns3_
