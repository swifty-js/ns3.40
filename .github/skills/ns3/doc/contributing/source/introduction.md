...
or reviewed by _maintainers_. |ns3| has a small core team of maintainers,
...
called the _mainline_, a term used further herein.
...
- Chapter 5 describes how to contribute code that will be stored outside
  of the |ns3| mainline, with emphasis on the |ns3| _AppStore_; and
