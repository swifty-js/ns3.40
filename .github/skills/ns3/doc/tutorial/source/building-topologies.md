...
point-to-point device _and_ a CSMA device. We then create a number of
...
rate is specified by a _channel_ `Attribute` instead of a device
...
_not_ modeled. By reading the model description (`csma.h`) you
