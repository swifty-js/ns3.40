...
In this case the _LLC_ and _MAC_ are sublayers of the OSI data link layer and
the _MII_ and _PHY_ are sublayers of the OSI physical layer.
...
transmission, all devices on the channel are _immediately_ aware of the
