...
G*{\mathrm{AA}}(\theta, \varphi)=\left|\boldsymbol{a}^{\mathrm{T}}(\theta, \varphi)
\boldsymbol{w}\left(\theta_0, \varphi_0\right)\right|^2=\left|\mathrm{AF}*{\mathrm{v}}(\theta,
...
\sum*{m=0}^{N*{\mathrm{v}}-1} e^{j k d\_{\mathrm{v}} m\left(\cos \theta-\cos \theta_0\right)}
..
...
\sum*{n=0}^{N*{\mathrm{h}}-1} e^{j k d\_{\mathrm{h}} n\left(\sin \theta
