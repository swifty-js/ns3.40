...
GetMtu behaviour. It will always return _at least_ 1280 bytes, as is the minimum IPv6 MTU.
...
The expected use cases (confirmed by the RFC editor) is to _never_ have a mixed environment
