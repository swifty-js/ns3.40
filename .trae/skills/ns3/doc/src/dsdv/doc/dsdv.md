...
`this URL <https://resilinets.org/resilinets_publications.html#.E2.80.9CDestination-Sequenced_Distance_Vector_.28DSDV.29*Routing_Protocol_Implementation_in_ns-3.E2.80.9D>`*.
