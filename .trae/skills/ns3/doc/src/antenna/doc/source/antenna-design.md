...
g(\phi, \theta) = \cos^{n} \left(\frac{\phi - \phi\_{0}}{2} \right)
...
n = -\frac{3}{20 \log*{10} \left( \cos \frac{\phi*{3dB}}{4} \right)}
...
g*{dB}(\phi, \theta) = -\min \left( 12 \left(\frac{\phi - \phi*{0}}{\phi*{3dB}} \right)^2, A*{max} \right)
...
considering only a single a single panel, i.e., :math:`N_{g} = M\_{g} = 1`.
