...
/_ Received a packet upon ESTABLISHED state. This function is mimicking the
role of tcp_rcv_established() in tcp_input.c in Linux kernel. _/
void
...
Now look at the third argument, in fact focus on the _argument_ of
...
system using what is called a _Config path_. We saw an example of
...
typedef void (_ CourseChangeCallback)(Ptr<const MobilityModel> _ model);
...
Tracing system is, _"Okay, I know that there must be trace sources in
the simulation core, but how do I find out what trace sources are
available to me?"_

The second question is, _"Okay, I found a trace source, how do I figure
out the Config path to use when I connect to it?"_

The third question is, _"Okay, I found a trace source and the Config
path, how do I figure out what the return type and formal arguments of
my callback function need to be?"_

The fourth question is, _"Okay, I typed that all in and got this
incredibly bizarre error message, what in the world does it mean?"_
...
_Okay, I know that there must be trace sources in the simulation core,
but how do I find out what trace sources are available to me?_
...
_Okay, I found a trace source, how do I figure out the Config path to
use when I connect to it?_
...
_Okay, I found a trace source and the Config path, how do I figure out
